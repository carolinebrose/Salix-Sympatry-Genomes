...
#SBATCH -e project/tanklab/cbrose1/Salix/Scripts/errors/err_trim_%A_%a.err   # EDIT TO YOUR DIRECTORY IN evoanalysis (or wherever else)
#SBATCH -o project/tanklab/cbrose1/Salix/Scripts/outs/std_trim_%A_%a.out   # EDIT TO YOUR DIRECTORY IN evoanalysis (or wherever else)
#SBATCH --array=1-24   # EDIT BASED ON HOW MANY SAMPLES

# Load fastp module
module load arcc fastp/0.23.4

# Define paths   - EDIT TO YOUR PATHS
RAW_DIR="/project/tanklab/cbrose1/Salix/NovogeneDownloads/01.RawData"
OUTDIR="/project/tanklab/cbrose1/Salix/SympatryGenomes/TrimmedFastqs"
REPORTDIR="/project/tanklab/cbrose1/Salix/SympatryGenomes/Reports/fastp_reports"
...
cd "$RAW_DIR"
dirs=( $(ls -d */ | grep -v "^Archive/$") ) #this should define all the directories except the one that has the OG files
